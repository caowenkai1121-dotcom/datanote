...
> 本地启动须 5 环境变量(`DB_HOST=38.76.183.50 DB_PORT=3307 DB_USERNAME=root DB_PASSWORD=datanote123 DATANOTE_CRYPTO_KEY=DataNote_AES_Key`);测试账号 admin/admin123、viewer/viewer123。中文请求体须 UTF-8 文件 `--data-binary @file`。
...
```bash
DB_HOST=38.76.183.50 DB_PORT=3307 DB_USERNAME=root DB_PASSWORD=datanote123 DATANOTE_CRYPTO_KEY=DataNote_AES_Key \
