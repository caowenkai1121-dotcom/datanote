    ...
    Promise.all([
      ...
      rbtn.onclick = function () {
        ...
        DN.get('/api/mdm/xref/resolve?sourceSystem=' + encodeURIComponent(sysIn.value.trim()) + '&sourceId=' + encodeURIComponent(idIn.value.trim())).then(function (d) {
          ...
          rout.appendChild(DN.h('div', { style: 'padding:10px 12px;border-radius:var(--radius-lg);background:var(--success-bg);border:1px solid var(--success-ring);font-size:13px' }, [
