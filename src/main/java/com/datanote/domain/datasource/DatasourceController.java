...
public class DatasourceController {
    ...
    public R<String> testConnection(@RequestBody DnDatasource ds) {
        try {
            ...
            String url;
            if (com.datanote.domain.datasource.MetadataService.isPg(ds.getType())) {
            ...
            } else if (com.datanote.domain.datasource.MetadataService.isSqlServer(ds.getType())) {
            ...
            } else if (com.datanote.domain.datasource.MetadataService.isOracle(ds.getType())) {
